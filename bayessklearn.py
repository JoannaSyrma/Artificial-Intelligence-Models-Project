...
def bayes(x_train, y_train,new_reviews, new_labels, train_size, iteration):
    accuracy_train = []
    accuracy_test = []
    precision_train = []
    precision_test = []
...
def evaluate(reviews, labels, new_reviews, new_labels,voc, iterations):
    ...
    for iteration in range(iterations):
        ...
        #bayes train and visualization of results
        bayes(x_train, y_train,new_reviews, new_labels, train_size, iteration)
...
evaluate(reviews, labels, new_reviews, new_labels, voc, iterations=5)
